...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "The Colour Motion Offer" },
      { name: "description", content: "Get your website for only 119000fcfa" },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "The Colour Motion Offer" },
      { property: "og:description", content: "Get your website for only 119000fcfa" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "The Colour Motion Offer" },
      { name: "twitter:description", content: "Get your website for only 119000fcfa" },
