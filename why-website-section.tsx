    ...
    <section className="relative min-h-screen flex flex-col justify-center overflow-hidden">
      ...
      <nav className="absolute top-0 left-0 right-0 z-50 px-4 py-4 sm:px-6 sm:py-6 md:px-12 lg:px-20">
        <div className="flex items-center justify-between">
          ...
          <motion.a
            href="https://wa.me/+237671842727?text=Bonjour%20The%20Colour%20Motion%2C%20je%20suis%20int%C3%A9ress%C3%A9(e)%20par%20l%27offre%20de%20cr%C3%A9ation%20de%20site%20web%20%C3%A0%20119%2C000%20FCFA.%20J%27aimerais%20en%20savoir%20plus%20sur%20les%20d%C3%A9tails%20de%20cette%20offre."
            target="_blank"
      ...
      <div className="relative z-10 px-4 sm:px-6 md:px-12 lg:px-20 pt-24 sm:pt-28 md:pt-32 pb-16 sm:pb-20">
        ...
        >
          ...
          Modern designs. Fast delivery. Unbeatable price.
        </motion.p>
        ...
        >
          <div className="flex flex-col sm:flex-row items-center gap-1 sm:gap-4">
            <span className="text-lg sm:text-2xl md:text-3xl text-muted-foreground line-through">
              250,000 FCFA
            </span>
