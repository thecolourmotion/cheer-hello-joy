...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Affordable Professional Websites for Businesses" },
      { name: "description", content: "Professional and affordable websites for businesses, startups, and personal brands. Responsive, modern, and built to convert visitors into customers." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Affordable Professional Websites for Businesses" },
      { property: "og:description", content: "Professional and affordable websites for businesses, startups, and personal brands. Responsive, modern, and built to convert visitors into customers." },
