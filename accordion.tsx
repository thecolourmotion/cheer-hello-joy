...
const testimonials = [
  {
    ...
    content: "My restaurant now gets 3x more reservations since we got our website. Best investment I made!",
    rating: 5,
  },
  {
    name: "Paul T.",
    role: "Boutique Owner",
    content: "Customers find us on Google now. The team delivered exactly what they promised, on time.",
    rating: 5,
  },
  {
    name: "Carine A.",
    role: "Event Planner",
    content: "Professional, fast, and affordable. My website looks like it cost 5x more. Highly recommend!",
    rating: 5,
  },
]
